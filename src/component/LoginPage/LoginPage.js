...
const LoginPage = () => {
  ...
  return (
    <div className="">
      <div className="w-full max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-900 dark:text-gray-100 mx-auto mt-[50px] bg-purple-500">
        ...
        <p className="text-xs text-center sm:px-6 dark:text-gray-400">
          ...
          <Link rel="noopener noreferrer" to="/register" className="underline dark:text-gray-100">
            Sign up
          </Link>
        </p>
      </div>
